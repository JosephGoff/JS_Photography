...
const Slider: React.FC = () => {
  ...
  return (
    <div className="embla md:hidden mb-[125px]">
      <div ref={SliderTitleRef} style={{opacity: 0, padding: "8px", transition: "opacity 1.5s ease-in-out, padding-top 1.5s ease-in-out"}}
      ...
      <div ref={SliderTitleRef2} style={{opacity: 0, marginTop: "8px", transition: "opacity 1.5s ease-in-out, margin-top 1.5s ease-in-out"}}
      ...
      <div
        ref={SliderControlsRef} style={{opacity: 0, marginTop: "8px", transition: "opacity 1.5s ease-in-out, margin-top 1.5s ease-in-out"}}
