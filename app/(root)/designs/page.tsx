...
const Designs = () => {
  ...
  useEffect(() => {
    ...
    if (tablet1) {
      const currentImageWidth =
        window.innerWidth / screenHeight > whratio
          ? window.innerWidth
          : screenHeight * whratio;

      const finalTabletWidth = screenHeight * (tabletWidth / tabletHeight);
      const currentWidthOfTablet =
        currentImageWidth * (tabletWidth / imageWidth);
      const tabletDifferenceToMakeUp =
        finalTabletWidth - currentImageWidth * (tabletWidth / imageWidth);
      const newTabletWidth =
        currentWidthOfTablet + percentThereValue * tabletDifferenceToMakeUp;

      tablet1.style.width = `${newTabletWidth}px`;
      tablet1.style.height = `${
        newTabletWidth * (tabletHeight / tabletWidth)
      }px`;
      setWhiteTabletWidth(newTabletWidth);

      tablet1.style.minWidth = `${currentWidthOfTablet}px`;
      tablet1.style.minHeight = `${
        currentWidthOfTablet * (tabletHeight / tabletWidth)
      }px`;
  ...
  useEffect(() => {
    ...
    if (tabletRef.current) {
      ...
      tabletRef.current.style.minHeight = `${
        currentWidthOfTablet * (tabletHeight / tabletWidth)
      }px`;
    }
  }, [page2]);
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (imageRef.current) {
        ...
        const finalWidthPercent =
          ((whratio * finalHeight) / window.innerWidth) * 100;
        const currentWidthPercent =
          window.innerWidth / screenHeight > whratio
            ? 100
            : ((screenHeight * whratio) / window.innerWidth) * 100;
        const differenceToMakeUp = finalWidthPercent - currentWidthPercent;
        imageRef.current.style.width = `${
          currentWidthPercent + percentThereValue * differenceToMakeUp
        }vw`;
      }
      ...
      if (tablet1) {
        ...
        const currentWidthOfTablet =
          currentImageWidth * (tabletWidth / imageWidth);
        const tabletDifferenceToMakeUp =
          finalTabletWidth - currentWidthOfTablet;
        const newTabletWidth =
          currentWidthOfTablet + percentThereValue * tabletDifferenceToMakeUp;
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (image1 && page2Ref && page2Ref.current === false) {
        ...
        const differenceToMakeUp = finalWidthPercent - currentWidthPercent;
        image1.style.width = `${
          currentWidthPercent + percentThere * differenceToMakeUp
        }vw`;
        ...
        if (tablet1) {
          ...
          let currentWidthOfTablet =
            currentImageWidth * (tabletWidth / imageWidth);
          let tabletDifferenceToMakeUp =
            finalTabletWidth - currentImageWidth * (tabletWidth / imageWidth);
          let newTabletWidth =
            currentWidthOfTablet + percentThere * tabletDifferenceToMakeUp;
          tablet1.style.width = `${newTabletWidth}px`;
          tablet1.style.height = `${
            newTabletWidth * (tabletHeight / tabletWidth)
          }px`;
          ...
          if (percentThere > 1 && newTabletWidth > window.innerWidth) {
            ...
            while (percentThere > 1 && newTabletWidth > window.innerWidth) {
              ...
              currentWidthOfTablet =
                currentImageWidth * (tabletWidth / imageWidth);
              tabletDifferenceToMakeUp =
                finalTabletWidth -
                currentImageWidth * (tabletWidth / imageWidth);
              newTabletWidth =
                currentWidthOfTablet + percentThere * tabletDifferenceToMakeUp;
            ...
            if (lastScrollRef) {
              lastScrollRef.current = testValidScroll;
            }
  ...
  return (
    <section ref={bodyRef} className="hide-scroll">
      ...
      {!page2 && (
        <div
          style={{ display: "flex", opacity: page === 0 ? 1 : 0, zIndex: 101 }}
          className="h-[calc(100vh-60px)] w-[100vw] flex items-center justify-center md:flex-row flex-col bg-background1"
        >
          <div
            ref={imageRef}
            style={{
          ...
          >
            <Image
              src={appData.S3_base_URL + "designs/ipad.png"}
              alt="contact"
              layout="fill"
              objectFit="cover"
            />
          ...
          >
            <div
              style={{
                ...
                padding:
                  percentThereValue > 1
                    ? whiteTabletWidth < window.innerWidth
                      ? "10px"
                      : 0
                    : "10px",
            ...
            >
              ...
              >
                <Image
                  ...
                  style={{
                    ...
                    borderRadius:
                      percentThereValue > 1
                        ? whiteTabletWidth < window.innerWidth
                          ? `${(whiteTabletWidth * 8) / tabletWidth}px`
                          : 0
                        : `${(whiteTabletWidth * 8) / tabletWidth}px`,
                    transition: "border-radius 0.8s ease",
                  }}
                  src={appData.S3_base_URL + "designs/ipad-bg.png"}
                  alt="contact"
                  layout="fill"
                  objectFit="cover"
                />
                ...
                >
                  <Image
                    style={{ maxWidth: "90%" }}
                    src={appData.S3_base_URL + "designs/my-designs.png"}
                    alt="contact"
                    layout="responsive"
                    width={500}
                    height={500}
      ...
      {showPage2 && (
        ...
        >
          ...
          >
            <Image
              src={appData.baseURL + "designs/img2.png"}
              alt="designs image"
              layout="responsive"
              objectPosition="center"
              width={400}
          ...
          >
            <Image
              src={appData.baseURL + "designs/img3.png"}
              alt="designs image"
              layout="responsive"
              objectPosition="center"
              width={400}
          ...
          >
            <Image
              src={appData.baseURL + "designs/img4.png"}
              alt="designs image"
              layout="responsive"
              objectPosition="center"
              width={400}
          ...
          >
            <Image
              src={appData.baseURL + "designs/img5.png"}
              alt="designs image"
              layout="responsive"
              objectPosition="center"
              width={400}
